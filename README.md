...
* Processes the following companies' spreadsheets of SRs in the following formats:
  * [MÁV Magyar Államvasutak Zrt.](https://www.mavcsoport.hu/mav/bemutatkozas) ([`.pdf`](data/01_import/MÁV_2022-08-08_ASR.pdf) converted to `.xlsx` manually on [ilovepdf.com](www.ilovepdf.com))
